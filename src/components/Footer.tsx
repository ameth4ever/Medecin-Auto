          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 text-argent/60 transition-all duration-300 hover:bg-[#FF0000] hover:text-white hover:shadow-lg hover:shadow-[#FF0000]/20"
